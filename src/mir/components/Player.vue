...
import Seeker from "./visualizations/Seeker.vue";
...
export default {
    ...
    methods: {
        ...
        drawWaveform() {
            if (!this.canvas) {
                console.log("Can't draw waveform; canvas is not created");
                return;
            }
            if (!this.ctx) {
                console.log("Can't draw waveform; canvas context is not created");
                return;
            }
